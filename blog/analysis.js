...
function createTopicSummary(data) {
    ...
    summary.innerHTML = `
        ...
        [<a href="/blog/analysis/">How I generated these topics</a><span class="desktop-only"> | </span><span class="desktop-only"><a href="#" class="toggle-analysis">Show detailed analysis</a></span>]</p>
    `;
    return summary;
}
